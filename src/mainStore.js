...
import {isValidDeadline, isValidWorkHours, parseDeadline, parseWorkHours} from "./components/DataParserAndValidator";
...
export default function createMainStore(data) {
